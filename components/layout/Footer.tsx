      ...
      <div className={styles.bottom}>
        <div className={`${styles.bottomInner} container`}>
          ...
          <div className={styles.socials}>
            <a href="https://www.instagram.com/autonexai_org/" target="_blank" rel="noreferrer"
              className={styles.social} aria-label="Autonex AI on Instagram">
              <InstagramIcon />
            </a>
            <a href="https://x.com/AutonexAi_Org" target="_blank" rel="noreferrer"
              className={styles.social} aria-label="Autonex AI on X (Twitter)">
              <XIcon />
            </a>
            <a href="https://www.linkedin.com/in/autonex-ai/" target="_blank" rel="noreferrer"
              className={styles.social} aria-label="Autonex AI on LinkedIn">
              <LinkedInIcon />
            </a>
          </div>
        </div>
